...
public class Apartado030101 extends Apartado {
	...
	public void ejercicio04() {
		...
		// Inicio modificacion
		_tablaCadenas = new String[2][];
		_tablaCadenas[0][0] = _matrizCadenas[0];
		_tablaCadenas[1][0] = _otraMatriz[0];
		// Fin modificacion
